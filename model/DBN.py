...
class KF_DBN:
    ...
    def accuracy_Test(self, y_test_num, b, c, d, q, r, W, test_name):
...
if __name__ == '__main__':
    ...
    Aver_time, perform_report, target_num, predict_num, acc_num, plt = model.accuracy_Test(A, B, C, D, Q, R, w, testName)   # 模型测试结果
