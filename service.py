...
def get_dbnModel_res(scenario, testName, typeName):
    upper_left_corner, data_pie, time_sum, x, y, upper_right_corner, lower_right_corner = DBN_RES(scenario, testName, typeName)
...
def get_lstmModel_res(scenario, testName, typeName):
    bottom_left_corner, time_sum, x, y, upper_right_corner, lower_right_corner = LSTM_RES(scenario, testName, typeName)
